...
#
#     PHX_SERVER=true bin/thalassaxir start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :thalassaxir, ThalassaxirWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  # No database needed - everything runs in-memory as Elixir processes
  ...
  #
  #     config :thalassaxir, Thalassaxir.Mailer,
